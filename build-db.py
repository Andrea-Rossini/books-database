...
db = pd.read_csv("/Users/andrearossini/PycharmProjects/books-database/books.csv", on_bad_lines='skip')

f = open("/Users/andrearossini/PycharmProjects/books-database/build_db.txt", 'w')
